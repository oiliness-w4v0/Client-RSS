...
export const usersRelations = relations(usersTable, ({ many }) => ({ feeds: many(feedsTable) }))

export const feedsRelations = relations(feedsTable, ({ many }) => ({ articles: many(articlesTable) }))
